...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Online Lottery System`}</title>

        <meta
          name="description"
          content="Experience the thrill with Online Lottery System, your gateway to new online lottery games worldwide, offering weekly jackpots of up to ₹5 Crore!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1518688248740-7c31f1a945c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsb3R0ZXJ5fGVufDB8fHx8MTY5NTgxMTM3N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@dylan_nolte?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`dylan nolte`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the thrill with Online Lottery System, your gateway to new online lottery games worldwide, offering weekly jackpots of up to ₹5 Crore!`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Game Administrator"
                  type="game-administrator"
