...
import { getCustomerSupportRepresentativeById } from 'apiSdk/customer-support-representatives';
import { CustomerSupportRepresentativeInterface } from 'interfaces/customer-support-representative';

function CustomerSupportRepresentativeViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Customer Support Representative Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Customer Support Representative Details
                  </Text>
                </Box>
                {hasAccess(
                  ...
                  <NextLink href={`/customer-support-representatives/edit/${id}`} passHref legacyBehavior>
                    <Button
...
)(CustomerSupportRepresentativeViewPage);
