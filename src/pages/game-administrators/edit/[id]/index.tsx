...
import { getGameAdministratorById, updateGameAdministratorById } from 'apiSdk/game-administrators';
...
function GameAdministratorEditPage() {
  ...
  const handleSubmit = async (values: GameAdministratorInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateGameAdministratorById(id, values);
      mutate(updated);
      resetForm();
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Update Game Administrator',
              isCurrent: true,
            },
          ]}
        />
